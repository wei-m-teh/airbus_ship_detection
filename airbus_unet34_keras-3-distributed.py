...
#    print(train_masks.head())
   print("calling make_image_gen on training samples")
...
#    print('y', train_y.shape, train_y.min(), train_y.max())
   ...
   print("calling make_image_gen on validation samples")
   valid_gen = make_image_gen(valid_masks, args.batch_size) # pull all validation samples
